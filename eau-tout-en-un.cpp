...
int main() {
    ...
    testMoyenne();
    testIndiceMax();
    cout << "Le volume total d’eau distribué dans l’année est de : " << somme(t) << "\nLe volume moyen par mois d’eau distribué dans l’année est de : " << moyenne(t) << "\nLe mois où on a distribué le plus d’eau est " << mois[indiceMax(t)] << " avec un volume de " << t[indiceMax(t)] << endl;
